...
function Field({ label, icon, right, error, success, children }) {
  return (
    <div>
      ...
      <div
        className={`flex items-center gap-2 h-11 px-3.5 rounded-[10px] border bg-[var(--cq-surface)] transition-all focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-[var(--cq-accent)] focus-within:ring-offset-[var(--cq-bg)] ${
          error
          ...
          <div className="w-full max-w-[420px]">
            ...
            <form onSubmit={onSubmit} className="mt-6 space-y-4" noValidate>
              ...
              {error && (
                <div
                  role="alert"
                  className="px-3 py-2 rounded-lg bg-[color-mix(in_oklch,var(--cq-danger)_12%,transparent)] text-[var(--cq-danger)] text-[13px] border border-[color-mix(in_oklch,var(--cq-danger)_30%,transparent)]"
                >
                  {error}
                </div>
              )}
